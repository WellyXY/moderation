...
const mockPosts: Post[] = [
	{
		...
		videoPrompt:
			"Create a mesmerizing digital art creation timelapse with artistic effects",
	},
	{
		id: "cm_2",
		userId: "user_cm_002",
		...
		videoPrompt:
			"Professional pasta making tutorial with warm kitchen atmosphere",
	},
	{
		id: "cm_3",
		userId: "user_cm_003",
		...
		videoPrompt:
			"Exciting mountain climbing adventure with safety tips and breathtaking views",
	},
	{
		id: "cm_4",
		userId: "user_cm_004",
		...
		videoPrompt:
			"Professional gadget unboxing and review with clean modern aesthetic",
	},
	{
		id: "cm_5",
		userId: "user_cm_005",
		...
		videoPrompt:
			"Music production behind the scenes with studio equipment and creative process",
	},
	{
		id: "cm_6",
		userId: "user_cm_006",
		...
		videoPrompt:
			"High-energy beginner fitness routine with clear instructions and motivation",
	},
	{
		id: "cm_7",
		userId: "user_cm_007",
		...
		videoPrompt:
			"Inspiring European travel vlog showcasing hidden gems and local culture",
	},
	{
		id: "cm_8",
		userId: "user_cm_008",
		...
		videoPrompt:
			"Adorable puppy training session with helpful tips and cute moments",
	},
	{
		id: "cm_9",
		userId: "user_cm_009",
		...
		videoPrompt:
			"Professional portrait photography tutorial with lighting setup and techniques",
	},
	{
		id: "cm_10",
		userId: "user_cm_010",
		...
		videoPrompt:
			"Practical small space gardening guide with vegetable growing tips",
	},
	{
		id: "cm_11",
		userId: "user_cm_011",
		...
		videoPrompt:
			"Natural makeup tutorial with step-by-step instructions and beauty tips",
	},
	{
		id: "cm_12",
		userId: "user_cm_012",
		...
		videoPrompt:
			"Classic car restoration showcase with detailed process and vintage aesthetics",
	},
	{
		id: "cm_13",
		userId: "user_cm_013",
		...
		videoPrompt:
			"Educational study tips video with organized presentation and helpful techniques",
	},
	{
		id: "cm_14",
		userId: "user_cm_014",
		...
		videoPrompt:
			"Creative DIY home decoration tutorial with step-by-step crafting instructions",
	},
	{
		id: "cm_15",
		userId: "user_cm_015",
		...
		videoPrompt:
			"French pronunciation tutorial with clear audio and educational formatting",
	},
	{
		id: "cm_16",
		userId: "user_cm_016",
		...
		videoPrompt:
			"Calming mindfulness meditation guide with peaceful atmosphere and soothing visuals",
	},
	{
		id: "cm_17",
		userId: "user_cm_017",
		...
		videoPrompt:
			"Exciting gaming highlights compilation with dynamic editing and epic moments",
	},
	{
		id: "cm_18",
		userId: "user_cm_018",
		...
		videoPrompt:
			"Clear economics education video with simple explanations and visual aids",
	},
	{
		id: "cm_19",
		userId: "user_cm_019",
		...
		videoPrompt:
			"Self-care guide for professionals with practical tips and calming presentation",
	},
	{
		id: "cm_20",
		userId: "user_cm_020",
		...
		videoPrompt:
			"Stargazing tutorial with beautiful night sky visuals and beginner-friendly guidance",
	},
]
	...
	return (
		<div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
			...
			<div className="p-3">
				...
				{/* Content Type Badge */}
				<div className="mb-2">{getContentTypeBadge(post)}</div>
		...
		.filter((post) => {
					...
					switch (appliedFilters.searchType) {
						...
						case "post_id":
							return searchIds.some((id) =>
								post.id.toLowerCase().includes(id),
							)
						case "audio_id":
							return searchIds.some((id) =>
								post.id.toLowerCase().includes(id),
						...
						case "edit_look_id":
							return searchIds.some((id) =>
								post.editLookId.toLowerCase().includes(id),
							)
						case "remix_id":
							return searchIds.some((id) =>
								post.id.toLowerCase().includes(id),
			...
			const matchesDateRange = (() => {
				...
				if (appliedFilters.dateFrom) {
					const dateFromMatch = appliedFilters.dateFrom.match(
						/^(\d{4})-(\d{2})-(\d{2})$/,
					)
					if (dateFromMatch) {
						const fromDate = new Date(appliedFilters.dateFrom)
						if (!isNaN(fromDate.getTime()) && fromDate > postDate)
							return false
					}
				}

				if (appliedFilters.dateTo) {
					const dateToMatch = appliedFilters.dateTo.match(
						/^(\d{4})-(\d{2})-(\d{2})$/,
					)
					if (dateToMatch) {
						...
						if (!isNaN(toDate.getTime()) && toDate < postDate)
							return false
					}
				}
			...
			const matchesLikes =
				!appliedFilters.minLikes ||
				post.likes >= Number.parseInt(appliedFilters.minLikes)
			const matchesComments =
				!appliedFilters.minComments ||
				post.comments >= Number.parseInt(appliedFilters.minComments)
			const matchesRemixes =
				!appliedFilters.minRemixes ||
				post.remixes >= Number.parseInt(appliedFilters.minRemixes)
		...
		<div className="p-6">
					...
					<div className="flex items-stretch min-w-0 flex-1 lg:min-w-[500px]">
						<div className="flex bg-white border border-gray-300 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
							...
							<button
								...
								className="px-6 py-3  text-white hover:bg-primary-700 transition-colors text-sm font-medium rounded-r-lg"
							>
								🔄 Apply Filters
							</button>
						</div>
			...
			<div className="flex justify-between items-center mb-4">
				<h3 className="text-lg font-semibold text-gray-900">
					Content ({filteredAndSortedPosts.length})
				</h3>
							...
							<div className="space-y-4">
								...
								<div className="flex justify-end space-x-3">
									...
									<button
										...
										className="px-4 py-2  text-white rounded-lg hover:bg-primary-700"
									>
										Save
									</button>
								</div>
